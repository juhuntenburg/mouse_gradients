...
data = nb.load('/home/julia/data/gradients/atlas/interneurons/vip2allen.nii.gz').get_data()
...
io.save_mesh('/home/julia/data/gradients/results/interneurons/vip_all_sampled_mesh.vtk', mesh)
