...
surr_file = data_dir+'surf3_surrogates.npy'
emp_var_file = data_dir+'surf3_emp_var.npy'
surr_var_file = data_dir+'surf3_surr_var.npy'
u0_file = data_dir+'surf3_u0.npy'

nsurr = 100000

# Construct sampled class
sampled = Sampled(gradients[:,3], distmat, index,
