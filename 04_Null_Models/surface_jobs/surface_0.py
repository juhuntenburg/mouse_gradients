...
data_dir = '/nfs/tank/shemesh/users/julia.huntenburg/revisions/null_models/surface/'
gradients = np.load(data_dir+'gradients1_6.npy')
distmat = data_dir+'distmat.npy'
index = data_dir+'index.npy'
surr_file = data_dir+'surf0_surrogates.npy'
emp_var_file = data_dir+'surf0_emp_var.npy'
surr_var_file = data_dir+'surf0_surr_var.npy'
u0_file = data_dir+'surf0_u0.npy'

nsurr = 100000

# Construct sampled class
sampled = Sampled(gradients[:,0], distmat, index,
