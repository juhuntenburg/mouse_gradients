...
surr_file = data_dir+'surf4_surrogates.npy'
emp_var_file = data_dir+'surf4_emp_var.npy'
surr_var_file = data_dir+'surf4_surr_var.npy'
u0_file = data_dir+'surf4_u0.npy'

nsurr = 100000

# Construct sampled class
sampled = Sampled(gradients[:,4], distmat, index,
