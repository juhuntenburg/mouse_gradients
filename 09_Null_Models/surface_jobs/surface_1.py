...
surr_file = data_dir+'surf1_surrogates.npy'
emp_var_file = data_dir+'surf1_emp_var.npy'
surr_var_file = data_dir+'surf1_surr_var.npy'
u0_file = data_dir+'surf1_u0.npy'

nsurr = 100000

# Construct sampled class
sampled = Sampled(gradients[:,1], distmat, index,
