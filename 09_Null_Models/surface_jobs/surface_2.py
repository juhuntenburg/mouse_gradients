...
surr_file = data_dir+'surf2_surrogates.npy'
emp_var_file = data_dir+'surf2_emp_var.npy'
surr_var_file = data_dir+'surf2_surr_var.npy'
u0_file = data_dir+'surf2_u0.npy'

nsurr = 100000

# Construct sampled class
sampled = Sampled(gradients[:,2], distmat, index,
